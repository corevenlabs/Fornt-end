...
export default function Whatsapp() {
  ...
  // Tu nuevo icono SVG optimizado
  const NewWhatsappIcon = () => (
    <svg 
      viewBox="0 0 24 24" 
  ...
  return (
    <div className="whatsapp-wrapper">
      <div 
        className={`whatsapp-button ${open ? 'hide' : ''}`} 
      ...
      {open && (
        <div className="whatsapp-popup">
          ...
          <div className="popup-footer">
            <a
              href="https://wa.me/56979242216?text=Hola,%20quiero%20cotizar"
              target="_blank"
